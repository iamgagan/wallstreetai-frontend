...
export const TabItem = ({ title, active, icon }: TabItemProps) => {
  return (
    <li
      className={`inline-flex gap-2 items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg ${active ? 'text-blue-600 border-b-2 border-blue-600 bg-accent' : ''} hover:text-gray-600 hover:border-gray-300 group`}
    >
      <div>{icon}</div>
      {title}
    </li>
