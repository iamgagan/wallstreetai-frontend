...
export const ImportFromLinkedIn = () => {
  ...
  const copyText = () => {
    navigator.clipboard
      .writeText('https://www.linkedin.com/in/' + text)
      .then(() => {
      ...
      <FormProvider {...form}>
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription>
              We will import your LinkedIn profile information to create your
              resume.
            </DialogDescription>
          </DialogHeader>
          <div className="flex items-start space-x-2">
            ...
            <Button
              type="button"
              size="sm"
              className="px-3 active:bg-white active:text-black"
              onClick={copyText}
            >
